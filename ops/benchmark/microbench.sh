...
run C2 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run
run C2 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run
run C2 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run
run C2 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run
run C2 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run
...
run C3 numactl --physcpubind=0 sysbench --events=10000000 --time=10 --num-threads=1 --cpu-max-prime=10000 cpu run

# CPU total capacity:
run C4 sysbench --events=10000000 --time=10 --num-threads=$ncpu --cpu-max-prime=10000 cpu run

# CPU performance, different workload (more to sanity check earlier results):
run C5 openssl speed -multi $ncpu rsa4096 2>&1 | egrep -v '^(Forked|\+)'
